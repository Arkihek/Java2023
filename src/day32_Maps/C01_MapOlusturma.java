...
public class C01_MapOlusturma {
    ...
    public static void main(String[] args) {
        ...
        // 1- Once istenen ogrencinin valuesunu bulalim ve kaydedelim
        String value103 = ogrenciMap.get(103); // Ali-Cem-11-K-TM

        // 2- Value ozel bir isaret ile birlestirilen farkli bilgilerden olusur
        //    split("-") ile bu bilgileri array`e donusturup kaydedelim
        String[] valueArray = value103.split("-"); // [Ali, Cem, 11, K, TM]
