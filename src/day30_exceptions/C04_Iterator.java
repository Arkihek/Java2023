...
public class C04_Iterator {
    ...
    public static void main(String[] args) {
        ...
        // List tum elementleri 2 arttirip yeni halini kaydedin
        ...
        /*
            ...
            Bu yapiarin hepsi index kullanmaz
        ...
        // degerleri 2 arttirip yazdirdik ancak list degismedi

        System.out.println();
        System.out.println(sayilar); // [7, 14, 5, 11]

        // foreach kullanarak list`in elementlerini 2 arttirip
