...
public class C04_ArraydeIstenenSartiSaglayanElementSayisiBulma {
    ...
    public static void main(String[] args) {
        ...
        int[] arr = {12, 2, 4, 6, 5, 1, 3, 1, 8, 6, 5};
        ...
        System.out.println("Verilen array`deki 3`e tam bolunenlerin adedi : " + sayac);
        ...
        System.out.println("Verilen array`de istenen sayi adedi : " + sayac);
