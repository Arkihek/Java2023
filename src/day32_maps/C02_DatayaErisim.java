...
public class C02_DatayaErisim {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(MapMethodlar.numaraIleOgrenciBulma(ogrenciMap, 103)); // Ali Cem
        System.out.println(MapMethodlar.numaraIleOgrenciBulma(ogrenciMap, 106)); // Sevgi Can
