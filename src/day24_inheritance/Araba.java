...
public class Araba {
    ...
    String tekerSayisi = "4";

    public void hiz(){
        System.out.println("Arabalar motor ve yakita gore max hix belirler");
    }
    ...
    /*
        ...
        sadece child class`larini organize etmek ve
        ortak ozellikleri belirlemek icin tasarlanan class`lardir.
        Bu tur class`larda main method olmasina gerek yoktur.
        (abstrack class ve interface`lerde ele alinacak)
