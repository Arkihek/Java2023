...
public class C04_AccessModifiers {
    ...
    /*
        Eger class level`daki bir variable
        veya method`da access modifier gorunmuyorsa
        ...
        Access modfıfıer ve static keyword birlikte degerlendirilmelidir
            ...
            - baska class`dan kullanimda ise static keyword erisim yontemini belirler
              static class uyeleri classIsmi.staticUyeIsmi sekilde kullanilirken
